...
$GLOBALS['rating_calculators']['main_v2'] = [
    'description' => '
        DSR rating v2
    ...
    'default_rating' => 2000,
    'fields' => [],
    'main' => 'dsr_main_v2__main',
    ];

function dsr_main_v2__main(&$teams) {
    ...
    foreach ($teams as &$team) {
        foreach ($team as &$player) {
            $multiplier = dsr_main_v2__get_multiplier($player['status']);
...
function dsr_main_v2__get_multiplier($status) {
    if ($status === 'lose') {
        return -1;
    }
