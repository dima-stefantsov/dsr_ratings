...
$GLOBALS['rating_calculators']['team'] = [
    'description' => '
        team main_current

        same as <a href="/rating/main_current">main_current</a>, but only for team games
        games you played with random pubs or alone do not affect this rating
        ',
...
function dsr_team__main(&$teams) {
    $teams_with_solo_team_rating = dsr_team__get_teams_with_solo_team_rating($teams);

    $GLOBALS['rating_calculators']['main_current']['main']($teams_with_solo_team_rating);

    dsr_team__assign_ratings($teams, $teams_with_solo_team_rating);
}

function dsr_team__get_teams_with_solo_team_rating(&$teams) {
    $ratings_solo_team = &$GLOBALS['rating_calculators']['team']['data']['ratings_solo_team'];
...
function dsr_team__assign_ratings(&$teams, &$teams_with_solo_team_rating) {
    $ratings_solo_team = &$GLOBALS['rating_calculators']['team']['data']['ratings_solo_team'];
