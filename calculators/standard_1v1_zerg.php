...
$GLOBALS['rating_calculators']['standard_1v1_zerg'] = [
    'description' => '
        standard 1v1 zerg
    ...
    'fields' => $fields,
    'main' => 'dsr_standard_1v1_zerg__main',
    ];

function dsr_standard_1v1_zerg__main(&$teams) {
    if ($teams[0][0]['mode'] !== 'standard' || $teams[0][0]['players_per_team'] !== '1v1') {
        return;
    }

    $teams_with_race_ratings = dsr_standard_1v1_zerg__get_teams_with_race_ratings($teams);
    $GLOBALS['rating_calculators']['main_current']['main']($teams_with_race_ratings);
    dsr_standard_1v1_zerg__assign_ratings($teams, $teams_with_race_ratings);
}

function dsr_standard_1v1_zerg__get_teams_with_race_ratings(&$teams) {
    $race_ratings = &$GLOBALS['rating_calculators']['standard_1v1_zerg']['data']['race_ratings'];
...
function dsr_standard_1v1_zerg__assign_ratings(&$teams, &$teams_with_race_ratings) {
    $race_ratings = &$GLOBALS['rating_calculators']['standard_1v1_zerg']['data']['race_ratings'];
